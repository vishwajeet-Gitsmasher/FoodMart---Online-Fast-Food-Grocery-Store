...
CREATE TABLE `users` (
  `user_id` int unique key not null auto_increment,
...
(3, 'varun', '123', 'ROLE_USER', 1, 'varun@gmail.com');
...
INSERT INTO PRODUCTS(description, image, name, price, quantity, weight, categoryid) VALUES
...
--
ALTER TABLE `users`
  MODIFY `role` varchar(45) default 1;
